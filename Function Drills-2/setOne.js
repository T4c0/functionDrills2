...
const oneLine = (param, param2) => console.log(`The first parameter is ${param}. The second parameter is ${param2}`)
...
greeting =(first, last,cb)=> {
cb(first+last)
}

// INVOKE 'GREETING FUNCTION' HERE
greeting('Julian','Vazquez', (fullName)=> {
